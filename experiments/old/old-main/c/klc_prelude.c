...
KLC_var KLCNZDClosureZEnew(KLCNList* captures, KLC_function f) {
  KLCNZDClosure* closure = (KLCNZDClosure*) malloc(sizeof(KLCNZDClosure));
  KLC_init_header(&closure->header, &KLC_typeZDClosure);
